...
//
//------------------------------------------------------------------------
if (!is_dir(APPLICATION_PATH . '/../public/tmp/jpgraph_cache/')){
    mkdir(APPLICATION_PATH . '/../public/tmp/jpgraph_cache/', 777, true);
}
define('CACHE_DIR',APPLICATION_PATH . '/../public/tmp/jpgraph_cache/');
